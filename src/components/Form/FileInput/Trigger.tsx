...
export function Trigger() {
  ...
  return (
    ...
    >
      <div className="rounded-full border-6 border-zinc-50 bg-zinc-100 p-2 duration-200 group-hover:border-violet-50 group-hover:bg-violet-100 dark:border-zinc-700 dark:bg-zinc-800 dark:group-hover:border-zinc-600 dark:group-hover:bg-zinc-700">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <span className="text-xs">SVG, PNG, JPG or GIF (max. 800px400px)</span>
      </div>
    </label>
  )
}
